...
@push('meta')
    ...
    <meta name="author" content="Daffa Eka Putri | daffaeka30.github.io">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    ...
                    <div class="justify-content-between align-items-center">
                        ...
                        <span class="text-dark link-hover me-3"><i class="fa fa-eye"></i> {{ $article->views }}</span>
                        <span class="text-dark link-hover me-3"><i class="fa fa-user-edit"></i>{{ $article->user->name }}</span>
                        <span class="text-dark link-hover float-end"><i class="fa fa-calendar-alt"></i> {{ date('d M Y', strtotime($article->published_at)) }}</span>
                    </div>
                        ...
                        <div class="tab-content">
                            <div id="tab-1" class="tab-pane fade show active">
                                <div class="row g-4 align-items-center">
                                    <div class="col-3">
                                        <img src="{{ asset('assets/frontend') }}/img/footer-4.jpg"
                                            class="img-fluid w-100 rounded" alt="">
                                    </div>
                                    <div class="col-9">
                                        <h3>{{ $article->user->name }}</h3>
                                        <p class="mb-0">Lorem ipsum dolor sit amet. Tempora inventore voluptatum quidem
                                            ducimus cumque esse dignissimos nulla quasi provident minima accusamus corporis
                                            libero eveniet consectetur, totam ea nihil! Incidunt eius maiores repudiandae
                                            quia reprehenderit eveniet cum perferendis.
                                        </p>
                                    </div>
                                </div>
                            </div>
