...
class ArticleController extends Controller
{
    ...
    public function store(ArticleRequest $request): JsonResponse
    {
        ...
        try {
            ...
            return response()->json([
                'message' => 'Data created failed' . $err->getMessage(),
            ]);
        }
    }
    ...
    {
        $article = $this->articleService->getFirstBy('uuid', $uuid);
    ...
    public function update(ArticleRequest $request, string $uuid)
    {
        ...
        try {
           if ($request->hasFile('image')) {
            ...
            return response()->json([
                'message' => 'Data updated failed' . $error->getMessage()
            ]);
        }
    }
    ...
    public function confirm(string $uuid)
    {
        ...
        $this->articleService->confirm($uuid);

        return redirect()->back()->with('success', 'Data confirmed successfully');
    }
